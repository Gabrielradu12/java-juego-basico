...
public class game_main  extends Canvas implements Runnable{
	...
	private static final long serialVersionUID = -3611882824308385348L;
	...
	//	AudioPlayer.load();
		...
		new window (WIDTH,HEIGHT, "CHACHI GAME",this);
	...
	private void render() {
		...
		if(gameState== STATE.Game) {
			...
			(gameState==STATE.Menu || gameState==STATE.Help|| gameState==STATE.End || gameState==STATE.Select) {
				menu.render(g);
